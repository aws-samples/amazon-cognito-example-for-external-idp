...
class GenerateConfig {
  ...
  async generateConfig(stackName: string, stackRegion: string, filePath: string, constName: string) {
...
new GenerateConfig().generateConfig(stackName, stackRegion, filePath, "autoGenConfigParams");
